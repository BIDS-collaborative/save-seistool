...
c
     ...
     1    5771.0,5971.0,6151.0,6291.0,6346.6,6351.0,6371.0,6371.0/
      data d/13.0885 ,12.5815 , 7.9565 , 7.9565 , 7.9565 , 5.3197 ,
     1 11.2494 , 7.1089 ,  2.691 ,  2.691 , 2.92   , 2.72    , 0.0,
     ...
     1 39.7027 ,20.3926 , 4.1875 , 4.1875 , 6.5    , 5.8     , 0.00,
     ...
     122.3512 , 8.9496 , 2.1519 , 2.1519 , 3.75    , 3.36    , 0.0,
...
c
 ...
 2    if(x1.ge.r(i)) go to 1
      i=i-1
      go to 2
 1    if(x1.le.r(i+1).or.i.ge.12) go to 3
      i=i+1
      if(i.lt.12) go to 1
